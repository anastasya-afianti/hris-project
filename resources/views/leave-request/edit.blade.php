                    ...
                    <div class="mb-4">
                       ...
                       <div class="mb-4">
                        ...
                        <input type="text" name="leave_type" id="leave_type"
                            ...
                            value="{{ old('leave_type', $leaveRequest->leave_type) }}" required>
                        @error('leave_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror"
                                ...
                                <option value="confirm" {{ old('status', $leaveRequest->status) == 'confirm' ? 'selected' : '' }}>Confirm</option>
                                <option value="reject" {{ old('status', $leaveRequest->status) == 'reject' ? 'selected' : '' }}>Reject
                                </option>
